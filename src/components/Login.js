          ...
          <div className='heading-2'>
            ...
            <form className='form-container' onSubmit={handleSubmit}>
              <div className='input-container'>
                ...
                <input value={logUserData.email} onChange={(e) => setlogUserData({...logUserData, username:e.target.value})} className='input-box' placeholder='username'/>
              </div>
              <div className='input-container'>
                <div className='input-label'>Password</div>
                <input type='password' value={logUserData.password} onChange={(e) => setlogUserData({...logUserData, password:e.target.value})} className='input-box' placeholder='atleast 8 charachters'/>
              </div>
